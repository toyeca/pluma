    ...
    >
      <h3 className="text-4xl  ">
        <span className="text-gray-lite dark:text-[#A6A6A6] ">
          ¡Hola! Me encantaría tener la oportunidad de ayudarte a alcanzar tus metas de fitness.
        </span>
        <br />
        <span className="font-semibold dark:text-white">
          ¡No dudes en ponerte en contacto conmigo para saber cómo puedo ayudarte!
        </span>
      </h3>
