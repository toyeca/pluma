...
const About = () => {
  ...
  return (
    <>
      <PageTitle title="Sobre me"></PageTitle>
      {/* End pagetitle */}
                ...
                <div className="col-span-12 md:col-span-8 space-y-2.5">
                  ...
                  <div className=" md:mr-12 xl:mr-16">
                    ...
                    <p className="text-gray-lite  dark:text-color-910 leading-7">
                      ...
                      pasión por la salud y el bienestar, Alvaro se ha dedicado
                      a ayudar a sus clientes a alcanzar sus metas físicas y
                      mejorar su calidad de vida. Con un enfoque en un
                      entrenamiento efectivo y seguro, Alvaro combina su
                      conocimiento académico con su experiencia práctica para
                      ofrecer a sus clientes un programa de entrenamiento
                      personalizado que se adapta a sus necesidades
                      individuales.
                    </p>
                    <p className="text-gray-lite leading-7 mt-2.5 dark:text-color-910">
                      Si está buscando un entrenador confiable y
                      comprometido, Alvaro es la persona perfecta para ayudarlo
                      a alcanzar sus objetivos de fitness.
                    </p>
                  </div>
