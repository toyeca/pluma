            ...
            <div className="grid grid-cols-1  md:grid-cols-2 gap-8">
              ...
              <div className="col-span-1">
                ...
                <div className="flex gap-y-5 gap-x-2.5 flex-wrap">
                  <button className="resume-btn">Pádel</button>
                  <button className="resume-btn">Aqua Gym</button>
                  <button className="resume-btn">Entrenamiento personal</button>
                  <button className="resume-btn">Pickleball</button>
                  <button className="resume-btn">Pilates</button>
                  <button className="resume-btn">Clases colectivas</button>
                </div>
              </div>
